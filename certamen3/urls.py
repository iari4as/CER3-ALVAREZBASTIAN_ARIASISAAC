...
from core.views import home, iniciarSesion,manageEvents,signout,registroUser,gestioneventos,EventoCreateAPIView, event_form,editar_evento, eliminar_evento, guardar_edit
urlpatterns = [
